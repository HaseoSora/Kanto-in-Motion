...
This is the **Kanto in Motion v1.3.4 No Pokémon Assets** package.
...
Use `tools/import_assets.py` or your established local asset workflow to populate compatible animated Pokémon assets.
