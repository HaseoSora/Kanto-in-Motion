...
Kanto in Motion v1.1.3 intentionally includes the small assets under `assets/trainer_card/` used by the integrated Modern UI Trainer Card. These are release assets rather than files generated by `tools/import_assets.py`.
