...
Kanto in Motion v1.3.4 is packaged in two variants.

## No Pokémon Assets package

`Kanto-in-Motion-v1.3.4-No-Pokemon-Assets.zip` excludes locally imported/generated Pokémon front/back/title artwork and the generated sprite metadata that directly depends on those payloads.
...
`Kanto-in-Motion-v1.3.4-Full-Assets.zip` contains the animated Pokémon/title payloads present in the maintainer's working release build.
