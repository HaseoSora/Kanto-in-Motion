...
Kanto in Motion v1.3.4 includes, adapts, or redistributes portions of third-party community work. Attribution does not imply endorsement and does not transfer ownership of the original work to Kanto in Motion.
...
Kanto in Motion contains compatibility code for several external mods but does **not** copy, patch, or redistribute their packages. This includes Quality of Life, Typed Move Colors, Overworld Wild Spawns / Wilds of Kanto, Gen2 Clean UI, Useful Bag, the Spanish translation mod, Advanced Box System, and other mods using KIM's public compatibility interfaces.
