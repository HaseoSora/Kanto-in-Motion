...
Kanto in Motion v1.3.3 includes, adapts, or redistributes portions of third-party community work. Attribution does not imply endorsement and does not transfer ownership of the original work to Kanto in Motion.
...
Kanto in Motion integrates the Kanto Rework battle-animation lineage used for the Gen 1 move-animation bridge and the KRS battle-background/routing data used by the v1.3.3 KRS arena choice.
