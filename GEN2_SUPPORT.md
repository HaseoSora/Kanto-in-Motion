...
Kanto in Motion v1.3.4 retains the Gen 2 support introduced in v1.2.0 for Gold, Silver, and Crystal on the Gen1Recomp 0.2.x architecture.
...
The v1.3.4 standalone **KANTO IN MOTION → BATTLE** system is currently Gen 1-only. Gen 2 keeps its established native/source-owned battle presentation.
